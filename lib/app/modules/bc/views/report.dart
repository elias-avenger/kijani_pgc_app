...
class BCReportFormScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final pcReportsController = TextEditingController();
    final descriptionController = TextEditingController();
    final otherActivityController = TextEditingController();
    final otherChallengeController = TextEditingController();

    // Listen to changes in these controllers to update the state
    pcReportsController.addListener(() {
      controller.pcReports.value = pcReportsController.text;
    });
    ...
    otherActivityController.addListener(() {
      controller.otherActivity.value = otherActivityController.text;
    });

    otherChallengeController.addListener(() {
      controller.otherChallenge.value = otherChallengeController.text;
    });
        ...
        child: Form(
          child: Column(
            ...
            children: [
              ...
              TextField(
                controller: pcReportsController,
              ...
              Obx(() {
                if (controller.selectedActivities
                  ...
                  return TextField(
                    controller: otherActivityController,
              ...
              EasyButton(
                ...
                onPressed: () {
                  if (_validateForm(controller)) {
                    ...
                    // Clear the input fields on form submission
                    pcReportsController.clear();
                    descriptionController.clear();
                    otherActivityController.clear();
                    otherChallengeController.clear();
                  }
                },
              ),
            ],
        ...
        children: [
          GestureDetector(
            onTap: controller.isLoading.value
                ? null
                : controller.pickImages, // Disable if loading
            child: Container(
              height: 100,
